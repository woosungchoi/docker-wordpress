...
if [ "$1" == "setup" ]; then
  ...
  read -p "[3/8] Enter your database username for wordpress (ex : dbuser) : " DATABASEUSER
  read -p "[4/8] Enter your database password for wordpress (ex : dbpassword) : " DATABASEPASSWORD
  read -p "[5/8] Enter your database name for wordpress (ex : wordpress) : " DATABASE
